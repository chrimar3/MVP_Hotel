...
class HumanLikeNLGEngine {
    ...
    initializeVocabulary() {
        this.vocabulary = {
            ...
            temporal: {
                ...
                frequency: ['always', 'consistently', 'usually', 'often', 'sometimes', 'occasionally', 'rarely'],
                specific: ['during breakfast', 'in the evening', 'late at night', 'early morning', 'around noon'],
                duration: ['throughout our stay', 'the entire time', 'for the duration', 'during our visit']
            },
            ...
            descriptors: {
                room: {
                    positive: ['spacious', 'immaculate', 'cozy', 'well-appointed', 'pristine', 'inviting', 
                              'comfortable', 'modern', 'elegant', 'spotless', 'airy', 'bright'],
                    negative: ['cramped', 'dated', 'worn', 'musty', 'noisy', 'dark', 'stuffy', 'tired-looking']
                },
                staff: {
                    positive: ['attentive', 'professional', 'courteous', 'knowledgeable', 'friendly', 
                              'accommodating', 'helpful', 'efficient', 'warm', 'responsive', 'proactive'],
                    negative: ['inattentive', 'unprofessional', 'rude', 'unhelpful', 'slow', 'indifferent']
                },
                food: {
                    positive: ['delicious', 'fresh', 'flavorful', 'well-prepared', 'varied', 'abundant',
                              'appetizing', 'excellent', 'tasty', 'memorable', 'divine'],
    ...
    initializeTransitions() {
        this.transitions = {
            additive: [
                ...
                'On top of that,', 'Another thing worth mentioning is that',
                'I should also mention that', 'It\'s worth noting that'
            ],
            contrastive: [
                'However,', 'On the other hand,', 'That said,', 'Nevertheless,',
                'Despite this,', 'In contrast,', 'Conversely,', 'Although,',
                'While I appreciated', 'The only downside was'
            ],
            causal: [
                'As a result,', 'Consequently,', 'This meant that', 'Because of this,',
                'This led to', 'Thanks to', 'Due to', 'Which explains why'
            ],
            exemplifying: [
                'For instance,', 'For example,', 'To give you an idea,', 'Case in point:',
                'One example:', 'Such as when', 'Like when', 'Particularly when'
            ],
            temporal: [
                'During our stay,', 'Throughout the visit,', 'On our first night,',
                'By the second day,', 'Towards the end,', 'Each morning,', 'Every evening,'
            ],
            emphasizing: [
                'Indeed,', 'In fact,', 'Actually,', 'To be honest,', 'Frankly,',
                'I must say,', 'I have to admit,', 'Surprisingly,'
            ]
        };
    }
    ...
    applyVoicePersonality(text, voice) {
        switch(voice) {
            case 'professional':
                ...
                return text.replace(/amazing/gi, 'excellent')
    ...
    getTimeReference(checkIn, checkOut) {
        const phrases = [
            ...
            `Last week`, `This past weekend`, `Just last month`
        ];
